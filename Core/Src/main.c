...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : BU6_Pin BU1_Pin BU2_Pin BU3_Pin
                           BU4_Pin BU5_Pin */
  GPIO_InitStruct.Pin = BU6_Pin|BU1_Pin|BU2_Pin|BU3_Pin
                          |BU4_Pin|BU5_Pin;
...
void matrizImprimirConsola(Matriz_t *matriz) {
   ...
   printf("\033[H\033[J"); // Limpia terminal
    printf("=== MATRIZ VIRTUAL (%dx%d) ===\r\n", MATRIZ_FILAS, MATRIZ_COLUMNAS);
    ...
    for (int f = 0; f < MATRIZ_FILAS; f++) {
        for (int c = 0; c < MATRIZ_COLUMNAS; c++) {
            ...
            if (r > 127 && g > 127 && b > 127) {
                ...
                printf("[X]"); //color miscelaneo
            } else {
                printf(" . "); // Pixel apagado
            }
        }
        printf("\r\n");
    }
